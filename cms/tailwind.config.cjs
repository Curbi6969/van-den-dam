...
// Scoped to the public frontend (the (frontend) route group). The Payload admin
// uses its own styles and is unaffected because @tailwind lives only in the
// frontend's globals.css. Tokens ported from the original site verbatim.
module.exports = {
