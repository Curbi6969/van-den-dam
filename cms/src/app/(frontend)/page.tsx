import './styles.css'
import { getHome } from '@/frontend/queries'
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 w-full">
          <div className="max-w-2xl">
            ...
            <p className="font-body text-xl text-white/80 leading-relaxed mb-10 max-w-xl">
              {home.hero.subtitle}
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[480px]">
            ...
            <div className="md:col-span-4 flex flex-col gap-6">
              {home.portfolio.slice(1).map((item, i) => (
                <article
                  key={i}
